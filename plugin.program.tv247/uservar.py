...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]TV247[/B][/COLOR]Wizard'
BUILDERNAME = 'TV247Wizard'
EXCLUDES = [ADDON_ID, 'repository.tv247']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://github.com/ashcan57/tv247/blob/master/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]TV247[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]TV247[/B][/COLOR]Wizard'
